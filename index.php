...
<body>
  ...
  <section class="container logosetif">
    ...
    <img class="logosetif" src="setifLogo.png">
  </section>
  ...
  <section class="parallax-sobre">
    ...
    <div class="container text-white">
      ...
      <h2 id="insc" class="font-weight-bold text-center pb-5 mt-7">As inscrições para as palestras e mini-cursos deverão ser
      ...
      <div class="p-3 mb-0 bg-white text-dark  position-absolute bottom-0 start-50 translate-middle-x rounded " style="width: 200px; --bs-bg-opacity: .7; ">
        <h1 class="text-black fw-lighter fs-4"> LOCALIZAÇÃO </h1>
      </div>
    </div>
  </section>
  ...
  <section class="parallax-programacao">
    <div class="container py-5">
      <div class="frame-programacao text-center">
        programação
        <div id="even3-widget-session">
          <iframe src="https://www.even3.com.br/widget/index?evento=setif-2022&amp;type=session&amp;lang=pt" id="even3_session" frameborder="0" allowfullscreen>
          </iframe>
        </div>
      </div>
    </div>
