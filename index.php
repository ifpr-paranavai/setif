...
<html lang="pt-BR">
  ...
  ?>
    <section class="container logosetif">
      <img
        class="img-fluid logosetif"
        src="imagens/setifLogo.png"
    ...
    <section class="parallax-sobre">
      <div class="container text-white">
        <h1 class="fs-1 font-weight-bold m-5 p-5 text-uppercase text-center">
          Sobre o Evento
        </h1>
        ...
        <h2 id="insc" class="font-weight-bold text-center pb-5 mt-5 mb-0">
          ...
          por meio do Even3:
          <a
            class="fw-lighter text-white text-decoration-none pb-5 mt-7"
            href="https://www.even3.com.br/setif-2022/"
            >https://www.even3.com.br/setif-2022/</a
          >
        </h2>
      </div>
    </section>
    ...
    <section class="parallax-programacao">
      <div class="container py-5">
        <div
          class="frame-programacao rounded-3 p-4"
      ...
      <div class="mt-5 bg-white bg-opacity-50 p-2" style="height:800px; width: auto;">
        <div class="card p-4 mt-3" style="width: 18rem; height: 5rem; margin-left: 43%;;">
          <h1 class="text-black fw-lighter fs-4 text-center">
           LOCALIZAÇÃO  <i class="bi bi-geo-alt"></i>
          </h1>
        </div>
      <div class="mapa d-flex flex-row justify-content-center" style="padding: 2rem;">
            <iframe
              class="rounded-3"
              style="height: 650px;"
