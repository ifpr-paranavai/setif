...
// Snapshot congelado da edição 2025: init.php passou a refletir a edição
// atual (2026), então esta página define seu próprio $evento em vez de
// herdar o global, pra manter os dados históricos corretos.
$evento = [
    'titulo' => 'SETIF 2025',
...
<body>
    ...
    <script src="assets/js/effects/particles.js"></script>
