...
<body>
  ...
  <body>
    ...
    <div class="container px-0 m-0">
      <div class="row">
        <div class="col">
          <div class="datas importantes custom-background h-max-content d-block d-inline-block d-flex p-10px text-white d-flex flex-column p-10">
            <h1 class=" fs-4 text-white font-weight-bold mt-1 mx-auto"><img src="./imagens/calendario.png" class="mx-2" alt="">Datas Importantes</h1>
            <br>
            <h4 class="mx-auto custom-font">Data limite para a submissão de trabalhos:</h4>
            <h4 class="mx-auto custom-font font-weight-light">10 de Outubro de 2023</h4>
            <br>

            <h4 class="mx-auto custom-font">Notificação aos autores:</h4>
            <h4 class="mx-auto custom-font font-weight-light">24 de outubro de 2023</h4>
            <br>

            <h4 class="mx-auto custom-font">Submissão da versão final:</h4>
            <h4 class="mx-auto custom-font font-weight-light">31 de outubro de 2023</h4>
            <br>

            <h4 class="mx-auto custom-font">Evento:</h4>
            <h4 class="mx-auto custom-font font-weight-light">07 a 11 de novembro de 2023</h4>
            <br>

            <h4 class="mx-auto custom-font">Data prevista da mostra de trabalhos:</h4>
        ...
        <div class="col">
          <div class="submissao col w-60 h-max-content d-flex p-10px col-7 d-block d-flex flex-column">
            ...
            <h5 class="text-body-secondary text-weight-lighter">No sistema, cada submissão deve ser feita em duas etapas:
              ...
              <h5 class="text-body-secondary text-weight-bold">Utilizar preferencialmente o LaTeX: Overleaf</h5>
              <br>
            ...
            <h5 class="text-body-secondary text-weight-lighter">No sistema, cada submissão deve ser feita em duas etapas:
              Os artigos completos devem possuir no máximo 12 páginas. A formatação dos artigos deve seguir o modelo da SBC para artigos acadêmicos:
              <h5 class="text-body-secondary text-weight-bold">Utilizar preferencialmente o LaTeX: Overleaf <br>
                Não incluir abstract e o resumo no modelo latex</h5>
              <br>
    ...
    <div class="apresentacao" style="display: block;padding:10px">
      <p>aa</p>
      <p>aa</p>
    </div>
